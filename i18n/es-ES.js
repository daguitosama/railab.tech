module.exports = {
    ...
    services: {
        ...
        intro: {
            ...
            secondaryLink: {
                body: 'Vea nuestros servicios →',
                tooltip: 'Valla al listado de servicios',
        ...
        list: {
            ...
            items: [
...

                {
                  ...
                  Tendrá un estimado del precio de la reparación.`,
                    listContent: null,
                },
...

                {
                    ...
                    textContent: null,
                    listContent: [
                        "Instalación de sistemas operativos macOs y aplicaciones",
...

                {
                  ...
                  Ud. obtiene dinero por un equipo en desuso y nosotros aseguramos que haya un Mac menos en algún basurero del país.`,
                    listContent: null,
                },

                {
                  ...
                  Si está interesado, contrate nuestros servicios.`,
                    listContent: null,
                },
            ],
        },
        ...
        QualityStamp: {
            heading: 'Sello de Calidad Railab',
            paragraph1: `Avalamos el perfecto estado de su Macbook por un período de 
            6 meses renovables, ya sea para tranquilidad propia o si desea venderla. 
            Para obtenerlo comuníquese con (nosotros). Los requisitos son:`,
            list1: [
                `Recibir un mantenimiento completo por el taller el cual incluye 
                cambio de pasta térmica, corrección de cables dañadas y cambio de 
                elementos sulfatados.`,
            ],
            paragraph2: `En el caso del Macbook`,
            list2: [
                `Vida de la batería por encima del 85%`,
