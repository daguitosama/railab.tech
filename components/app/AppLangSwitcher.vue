    ...
    <div class="relative">
        <div class="relative">
            <button
                ...
                class="p-2 rounded-xl border h-full focus:outline-none focus:ring focus:ring-brand focus:ring-offset-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition-shadow duration-200 ease-linear flex items-center"
            >
                <svg
                    width="16"
                    height="16"
        ...
        <div
          ...
          class="fixed z-40 inset-0 bg-indigo-600 h-full w-full"
        >
        hey
        </div>
       </transition>  -->
